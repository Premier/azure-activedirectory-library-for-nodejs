 ...
 * @param  {AcquireTokenCallback} callback
 */
TokenRequest.prototype._getTokenUsernamePasswordManagedSecret = function(username, password, clientSecret, callback) {
  this._log.verbose('Acquiring token with username password for managed user');
 ...
 * @param  {AcquireTokenCallback} callback
 */
TokenRequest.prototype.getTokenWithUsernamePasswordSecret = function(username, password, clientSecret, callback) {
  this._log.info('Acquiring token with username password');
  this._userId = username;
  ...
  this._getTokenWithCacheWrapper(callback, function(getTokenCompleteCallback) {
    var self = this;
      ...
      if(this._authenticationContext._authority._isAdfsAuthority) {
        ...
        self._getTokenUsernamePasswordManagedSecret(username, password, clientSecret, getTokenCompleteCallback);
        return;
      }
